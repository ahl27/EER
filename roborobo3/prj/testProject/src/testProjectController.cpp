...
testProjectController::testProjectController( RobotWorldModel *__wm ) : Controller ( __wm )
{
...
void testProjectController::reset()
{
	// nothing to do.
}

void testProjectController::step()
{
...
void testProjectController::monitorSensoryInformation()
{
...
std::string testProjectController::inspect( std::string prefix )
{
